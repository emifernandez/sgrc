@extends('layouts.app')
@section('title', 'Admisiones Pendientes')
@section('menu-header')
    <li class="breadcrumb-item active">Admisiones Pendientes</a></li>
@endsection
@section('content')
<div class="col-sm-12">
  </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="display: block;  margin: auto;">
                            <a href="{{ route('registro-consulta.edit', $admision->admision) }}" class= "btn btn-info"><i class="fas fa-plus-circle"></i> Crear Consulta</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
