                            ...
                            <form role="form" id="form" method="POST" action="{{ route('admision.update', $admision->admision) }}">
                                ...
                                <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    name="fecha_admision"
                                                    id="fecha_admision"
                                                    value="{{ old('fecha_admision', $admision->fecha_admision->forForm()) }}">
                                                </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    name="fecha_registro"
                                                    id="fecha_registro"
                                                    value="{{ old('fecha_registro', $admision->fecha_registro->forForm()) }}">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="prioridad" id="prioridad">
                                                    @foreach($prioridades as $key => $prioridad)
                                                        <option value="{{ $key }}"
                                                            @if($key == old('prioridad', $admision->prioridad)) selected @endif
                                                            >{{ $prioridad }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="estado" id="estado">
                                                    @foreach($estados as $key => $estado)
                                                        <option value="{{ $key }}"
                                                            @if($key == old('estado', $admision->estado)) selected @endif
                                                            >{{ $estado }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <select class="form-control" name="establecimiento" id="establecimiento">
                                            @foreach($establecimientos as $key => $establecimiento)
                                                <option value="{{ $establecimiento->establecimiento }}"
                                                    @if($establecimiento->establecimiento == old('establecimiento', $admision->establecimiento)) selected @endif
                                        ...
                                        <select class="form-control" name="derivacion" id="derivacion">
                                            ...
                                            @foreach($derivaciones as $key => $derivacion)
                                                <option value="{{ $derivacion->derivacion }}"
                                                    @if($derivacion->derivacion == old('derivacion', $admision->derivacion)) selected @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="especialidad" id="especialidad_admision">
