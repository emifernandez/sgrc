...
@section('menu-header')
    <li class="breadcrumb-item"><a href="{{ route('referencia.index') }}">Referencias</a></li>
    <li class="breadcrumb-item active">Crear Referencia</a></li>
@endsection
@section('content')
<div class="row">
	<div class="col-lg-12">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Crear Referencia</h3>
                            </div>
                            <form role="form" id="form" method="POST" action="{{ route('referencia.store') }}">
                                @csrf
                                <input type="hidden" name="consulta" id="consulta" value="{{ $consulta->consulta }}">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-3">
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#modal-loading" >
                                        Grabar</button>
