...
@section('menu-header')
    ...
    <li class="breadcrumb-item active">Editar Horario</a></li>
@endsection
@section('content')
<div class="row">
	<div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form role="form" id="form" method="POST" action="{{ route('horario.update', $horario->horario) }}">
                                @method('PATCH')
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="dia" id="dia">
                                                    @foreach($dias as $key => $dia)
                                                        <option value="{{ $key }}"
                                                            @if($key == old('dia', $horario->dia)) selected @endif
                                                            >{{ $dia }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="estado" id="estado">
                                                    @foreach($estados as $key => $estado)
                                                        <option value="{{ $key }}"
                                                            @if($key == old('estado', $horario->estado)) selected @endif
                                                            >{{ $estado }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <select class="form-control" name="establecimiento" id="establecimiento">
                                            @foreach($establecimientos as $key => $establecimiento)
                                                <option value="{{ $establecimiento->establecimiento }}"
                                                    @if($establecimiento->establecimiento == old('establecimiento', $horario->establecimiento)) selected @endif
                                        ...
                                        <select class="form-control" name="especialidad" id="especialidad">
                                            @foreach($especialidades as $key => $especialidad)
                                                <option value="{{ $especialidad->especialidad }}"
                                                    @if($especialidad->especialidad == old('especialidad', $horario->especialidad)) selected @endif
                                        ...
                                        <select class="form-control" name="funcionario" id="funcionario">
                                            @foreach($funcionarios as $key => $funcionario)
                                                <option value="{{ $funcionario->funcionario }}"
                                                    @if($funcionario->funcionario == old('funcionario', $horario->funcionario)) selected @endif
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    name="hora_desde"
                                                    id="hora_desde"
                                                    value="{{ old('hora_desde', $horario->hora_desde->format('H:i')) }}">
                                                </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    name="hora_hasta"
                                                    id="hora_hasta"
                                                    value="{{ old('hora_hasta', $horario->hora_hasta->format('H:i')) }}">
                                                </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="{{ old('capacidad_atencion', $horario->capacidad_atencion) }}"
                                                    placeholder="0">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    name="uso_atencion"
                                                    id="uso_atencion"
                                                    value="{{ old('uso_atencion', $horario->uso_atencion) }}"
                                                    placeholder="0">
