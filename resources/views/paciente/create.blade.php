...
@section('menu-header')
    ...
    <li class="breadcrumb-item active">Crear Paciente</a></li>
@endsection
@section('content')
<div class="row">
	<div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form role="form" id="form" method="POST" action="{{ route('paciente.store') }}">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="tipo_documento" id="tipo_documento">
                                                    @foreach($tipos_documentos as $key => $tipo_documento)
                                                        <option value="{{ $key }}"
                                                            @if($key == old('tipo_documento')) selected @endif
                                                ...
                                                <select class="form-control" name="nacionalidad" id="nacionalidad">
                                                    @foreach($nacionalidades as $key => $nacionalidad)
                                                        <option value="{{ $nacionalidad->nacionalidad }}"
                                                            @if($nacionalidad->nacionalidad == old('nacionalidad')) selected @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="tipo_lugar" id="tipo_lugar">
                                                    @foreach($tipos_lugares as $key => $tipo_lugar)
                                                        <option value="{{ $key }}"
                                                            @if($key == old('tipo_lugar')) selected @endif
                                                            >{{ $tipo_lugar }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="estado_civil" id="estado_civil">
                                                    @foreach($estados_civiles as $key => $estado_civil)
                                                        <option value="{{ $key }}"
                                                            @if($key == old('estado_civil')) selected @endif
                                                            >{{ $estado_civil }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <select class="form-control" name="seguro" id="seguro">
                                            @foreach($seguros as $key => $seguro)
                                                <option value="{{ $seguro->seguro }}"
                                                    @if($seguro->seguro == old('seguro')) selected @endif
                                        ...
                                        <select class="form-control" name="nivel_educativo" id="nivel_educativo">
                                            @foreach($niveles as $key => $nivel_educativo)
                                                <option value="{{ $nivel_educativo->nivel_educativo }}"
                                                    @if($nivel_educativo->nivel_educativo == old('nivel_educativo')) selected @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="etnia" id="etnia">
                                                    @foreach($etnias as $key => $etnia)
                                                        <option value="{{ $key }}"
                                                            @if($key == old('etnia')) selected @endif
                                                            >{{ $etnia }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="situacion_laboral" id="situacion_laboral">
                                                    @foreach($situaciones_laborales as $key => $situacion_laboral)
                                                        <option value="{{ $key }}"
                                                            @if($key == old('situacion_laboral')) selected @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="area" id="area">
                                                    @foreach($areas as $key => $area)
                                                        <option value="{{ $key }}"
                                                            @if($key == old('area')) selected @endif
                                                            >{{ $area }}</option>
                                                    @endforeach
                                                </select>
