...
@section('menu-header')
    ...
    <li class="breadcrumb-item active">Editar Enfermedad</a></li>
@endsection
@section('content')
<div class="row">
	<div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form role="form" id="form" method="POST" action="{{ route('enfermedad.update', $enfermedad->enfermedad) }}">
                                @method('PATCH')
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"
                                            ...
                                            name="descripcion"
                                            id="descripcion"
                                            value="{{ old('descripcion', $enfermedad->descripcion) }}"
