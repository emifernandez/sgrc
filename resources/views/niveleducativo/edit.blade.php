...
@section('menu-header')
    ...
    <li class="breadcrumb-item active">Editar Nivel Educativo</a></li>
@endsection
@section('content')
<div class="row">
	<div class="col-lg-12">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Editar Nivel Educativo</h3>
                            </div>
                            <form role="form" id="form" method="POST" action="{{ route('nivel-educativo.update', $nivel_educativo->nivel_educativo) }}">
                                @method('PATCH')
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            name="nombre"
                                            id="nombre"
                                            value="{{ old('nombre', $nivel_educativo->nombre) }}"
