...
class UpdateEstablecimientoRequest extends FormRequest
{
    ...
    {
        return [
            'codigo' => 'required|max:3|unique:establecimientos,codigo,' . $this->establecimiento->establecimiento . ',establecimiento',
            'nombre' => 'required|max:60|unique:establecimientos,nombre,' . $this->establecimiento->establecimiento . ',establecimiento',
            'tipo' => 'required',
            'red' => 'required',
